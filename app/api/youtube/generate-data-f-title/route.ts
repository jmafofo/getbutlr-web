...
export async function POST(req: NextRequest) {
  ...
  const prompt = `
You are a viral YouTube content strategist. Given the seed idea: "${userQuery}", generate 5 distinct and trending YouTube video ideas. Each idea must include a unique title and an engaging 2-sentence description optimized for clicks and watch time.
